...
try:
    # Verificar se a string de conexão com o banco de dados está definida
    if not settings.DATABASE_URL:
        logger.error("Erro: String de conexão com o banco de dados não definida.")
    ...
    # Criar engine com sqlite em memória para evitar falhas catastróficas
    engine = create_engine(
        "sqlite:///:memory:",
